<template>
    <div>
        <NuxtLayout name="login">
            <Teleport to="body">
                <Alert :alert-msg="alertMsg" :show="isAlertShow" icon="i-heroicons-x-circle-16-solid"
                ...
                <div
                    ...
                    <form class="flex flex-col gap-4">
                        <div class="flex flex-col gap-1">
                            ...
                            <UInput v-model="user.username" type="text" placeholder="Enter your username" />
                        </div>
                        <div class="flex flex-col gap-1">
                            <label>Password</label>
                            <UInput v-model="user.password" type="password" placeholder="Enter your password" />
                        </div>
                        <div class="flex justify-end">
                            <UButton @click="login">Sign In</UButton>
                        </div>
                    </form>
                </div>
            </div>
